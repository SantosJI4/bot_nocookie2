...
async def perfil(ctx, member: discord.Member = None):
    ...
    # Fontes
# Certifique-se de que o arquivo arial.ttf está no diretório do projeto ou em um local acessível
    fonte_titulo = ImageFont.truetype("fonts/arial.ttf", 40)
    fonte_texto = ImageFont.truetype("fonts/arial.ttf", 30)
    fonte_destaque = ImageFont.truetype("fonts/arial.ttf", 35)
